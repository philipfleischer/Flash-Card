...
const DocumentListPage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {isUploadModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            ...
            {/* Modal Header */}
            <div className="mb-6">
              <h2 className="text-cl font-medium text-slate-900 tracking-tight">
                Upload New Document
              </h2>
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full h-12 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:bg-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10"
              ...
              <div className="space-y-2">
                ...
                <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-400 hover:bg-emerald-50/30 transition-all duration-200">
                  <input
                    id="file-upload"
                    type="file"
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate200/60 rounded-2xl shadow-2xl shadow-slate900/20 p-8">
            {/* Close Button */}
            <button
            ...
            <p className="text-sm text-slate-600 mb-6">
              ...
              <span className="font-semibold text-slate-900">{selectedDoc?.title}</span>? This
