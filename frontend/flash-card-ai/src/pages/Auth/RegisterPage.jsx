...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = err?.error || err?.message || 'Failed to register. Please try again.';
      setError(msg);
      toast.error(msg);
    } finally {
      setLoading(false);
      ...
      <div className="relative w-full max-w-md px-6">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br from bg-emerald-400 to-teal-500 shadow-lg shadow-emerald-500/25 mb-6">
