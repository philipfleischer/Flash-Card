...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="absolute inset-0 bg-[radial-gradient(#35e7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-30 pointer-events-none" />

      <div className="relatice max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6">
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
          ...
          (dashboardData.recentActivity.documents.length > 0 ||
            ...
            <div className="text-center py-12">
              ...
              <p className="text-xs text-slate-500 mt-1">Star learning to see your progress here</p>
            </div>
          )}
        </div>
      </div>
